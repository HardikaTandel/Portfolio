    ...
    <div id='tools' className='text-white py-16'>
        <div className='container mx-auto text-center'>
            ...
            <div className='overflow-hidden w-full relative'>
                ...
                className='whitespace-nowrap flex space-x-10'>
                     {duplicatedTechTools.map((techtool, index)=>(
                      <div key={index} className='text-lg bg-gray-600 sm:bg-gray-700 md:bg-gray-800 px-6 py-3 inline-block rounded-4xl shadow-xl border-2 border-gray-500'>
                        {techtool}
                      </div>
                     ))}
                </motion.div>
            ...
            <div className='overflow-hidden relative w-full mt-5'>
                ...
                {duplicatedTechTools.map((techtool, index)=>(
                      <div key={index}
                      className='text-lg bg-gray-600 sm:bg-gray-700 md:bg-gray-800 px-6 py-3 inline-block rounded-4xl shadow-xl border-2 border-gray-500'>
                        {techtool}
                      </div>
                     ))}
                </motion.div>
